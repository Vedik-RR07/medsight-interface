        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  {roles.map((r) => (
                    <button
                      key={r}
                      onClick={(e) => { e.stopPropagation(); setRole(r.toLowerCase()); }}
              ...
              <div className="pt-2 space-y-2">
                ...
                <div className="flex gap-2">
                  <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-muted border border-border text-sm text-foreground hover:border-primary/30 transition">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/dashboard"
                className="glow-button w-full py-2.5 rounded-lg font-medium text-sm flex items-center justify-center gap-2 mt-2"
              >
                Log in <span>→</span>
              </Link>
            </div>
